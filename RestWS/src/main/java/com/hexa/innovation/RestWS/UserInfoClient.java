...
public class UserInfoClient {
	...
	public static final String BASE_URI = "http://localhost:7080/RestWS";
	...
	public static void main(String[] args) {
		...
		WebResource nameResource = resource.path("hexaware").path(PATH_NAME + name);
		System.out.println("Client Response \n"
				+ getClientResponse(nameResource));
		System.out.println("Response \n" + getResponse(nameResource) + "\n\n");

		WebResource ageResource = resource.path("hexaware").path(PATH_AGE + age);
		System.out.println("Client Response \n"
